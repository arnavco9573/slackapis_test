...
const StrategySteps = [
    {
        id: 'category-1',
        desc: 'Communication Entry',
        icon: CommunicationEntryIcon
    },
    {
        id: 'category-2',
        desc: 'Business Foundation',
        icon: BusinessFoundationIcon
    },
    {
        id: 'category-3',
        desc: 'Infrastructure Basics',
        icon: InfrastructureBasicsIcon
    },
    {
        id: 'category-4',
        desc: 'Orientation',
    ...
    },
    {
        ...
        icon: StrategySelectionIcon
    },
    {
        id: 'category-6',
        desc: 'Performance Verification',
    ...
    {
        id: 'category-9',
        desc: 'Capital Development',
        icon: CapitalDevelopmentIcon
    },
    {
        id: 'category-10',
        desc: 'Offering Documents',
        icon: OfferingDocumentsIcon
    },
    {
        id: 'category-11',
...
interface ChecklistStickyHeaderProps {
    currentCategoryId: string;
    onCategoryChange: (id: string) => void;
}

const ChecklistStickyHeader = ({ currentCategoryId, onCategoryChange }: ChecklistStickyHeaderProps) => {
    return (
        <div className="sticky top-0 z-30 w-full bg-neutral-01 section-border">
            <div className="flex overflow-x-auto scroll-smooth p-6 " style={{ scrollbarWidth: "none" }}>
                <div className="flex gap-5 lg:gap-5 xl:gap-5 2xl:gap-20 justify-between">
                    {StrategySteps.map((step) => {
                        ...
                        return (
                            <button
                                key={step.id}
                                className={cn(
                                    'flex flex-col justify-center items-center gap-3 cursor-pointer min-w-[140px] transition-all duration-300',
                                ...
                                <div
                                    className={cn(
                                        ...
                                        isActive
                                            ...
                                            : 'checklist-category-inactive text-neutral-40 hover:opacity-100'
                                    )}
                                >
...
export default ChecklistStickyHeader;
