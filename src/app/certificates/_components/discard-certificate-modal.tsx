...
interface DiscardCertificateModalProps {
    isOpen: boolean
    onClose: () => void
    onConfirm: () => void
}

const DiscardCertificateModal = ({
    isOpen,
    onClose,
    onConfirm,
}: DiscardCertificateModalProps) => {
    return (
                ...
                <div className="relative flex flex-col items-center p-10 pb-8 gap-0">
                    ...
                    <div className="flex flex-col items-center gap-2 mb-10 text-center">
                        <p className="text-sm font-normal text-(--Primary-600) leading-[24px]">
                            Are you sure you discard <br /> certificate assignment?
                        </p>
                    </div>
...
export default DiscardCertificateModal
