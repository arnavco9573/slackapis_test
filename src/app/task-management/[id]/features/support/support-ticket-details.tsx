            ...
            leftColumnContent={
                <div className="flex flex-col gap-8 p-6">
                    ...
                    <div className="flex flex-col gap-6">
                        <h3 className="text-base text-text-highest font-normal">Support Ticket Details</h3>
                    ...
                    <div className="flex justify-end mt-4">
                        ...
                        >
                            {isLoading ? 'Processing...' : currentTask.status === 'completed' ? 'Resolved' : 'Resolve'}
                        </Button>
                    </div>
                </div>
            }
