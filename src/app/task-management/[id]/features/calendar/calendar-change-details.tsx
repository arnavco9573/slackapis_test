...
import MessageToInvestor from '../../../_components/Message-to-investor';
...
export default function CalendarChangeDetails() {
    ...
    return (
        <TaskPageLayout
            leftColumnContent={
                <div className="flex flex-col gap-8 p-6">
                    ...
                    <div className="flex flex-col gap-6">
                        <h3 className="text-base text-text-highest font-normal">Request Details</h3>
                    ...
                    <div className="flex flex-col gap-4 pt-8">
                        <h3 className="text-lg text-text-highest font-medium uppercase text-[10px] tracking-wider text-text-low">Requested calendar email</h3>
            ...
            rightColumnContent={<MessageToInvestor taskId={currentTask.id} />}
            actionPanel={
                <TaskActionPanel
